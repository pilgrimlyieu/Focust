const enUS = {
  about: {
    ...
    license: "License",
    lifecycle: "Application Control",
    majorUpdate: "Major Update",
    majorUpdateDesc:
      "Major version updates may include breaking changes. Please review the release notes before updating.",
    minorUpdate: "Minor Update",
    minorUpdateDesc: "This update includes new features and improvements.",
    ...
    zeroVerWarning:
      "⚠️ This project is in 0.x stage. Updates may introduce frequent changes.",
  },
  actions: {
    add: "Add",
    browse: "Browse",
  ...
  general: {
    ...
    pausedResumeHint: "Resume button only removes user-started pauses",
    ...
    timedPauseRemaining: "resumes in {time}",
