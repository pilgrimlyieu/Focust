...
Write-Host "🔐 Focust Code Signing Setup" -ForegroundColor Cyan
...
# Step 1: Generate key
Write-Host ""
Write-Host "📝 Step 1: Generate Signing Key" -ForegroundColor Yellow
Write-Host "--------------------------------"
...
# Extract public key
Write-Host ""
Write-Host "🔑 Extracting public key..." -ForegroundColor Yellow
Write-Host ""
Write-Host "⚠️  IMPORTANT: Copy the PUBLIC KEY from the output above" -ForegroundColor Yellow
Write-Host ""
...
Write-Host ""
Write-Host "📝 Step 2: Update Configuration" -ForegroundColor Yellow
Write-Host "--------------------------------"
...
Write-Host "✅ Updated tauri.conf.json (backup saved)" -ForegroundColor Green

# Step 3: Create .env file
Write-Host ""
Write-Host "📝 Step 3: Create .env File" -ForegroundColor Yellow
Write-Host "----------------------------"

$envContent = @"
# Tauri Updater Configuration
# Auto-generated by setup-updater-signing.ps1
...
Write-Host ""
Write-Host "📝 Step 4: GitHub Secrets (for CI/CD)" -ForegroundColor Yellow
Write-Host "--------------------------------------"
Write-Host ""
...
Write-Host "📚 For detailed instructions, see: docs\UPDATER_SIGNING.md"
Write-Host ""
