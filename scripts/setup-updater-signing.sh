...
echo "🔐 Focust Code Signing Setup"
echo "=============================="
echo ""
...
echo ""
echo "⚠️  IMPORTANT: Copy the PUBLIC KEY from the output above"
echo ""
...
if command -v jq &> /dev/null; then
    ...
    echo "✅ Updated tauri.conf.json (backup saved)"
else
    echo "⚠️  jq not found, please manually update tauri.conf.json"
...
# Auto-generated by setup-updater-signing.sh
...
echo ""
echo "📝 Step 4: GitHub Secrets (for CI/CD)"
echo "--------------------------------------"
echo ""
...
echo "📚 For detailed instructions, see: docs/UPDATER_SIGNING.md"
echo ""
echo "✅ Setup complete!"
echo ""
echo "Next steps:"
